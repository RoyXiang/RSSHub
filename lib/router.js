...
router.get('/nyaa/user/:user', lazyloadRouteHandler('./routes/nyaa/user'));

// 漫猫BT
router.get('/comicat/:keyword?', lazyloadRouteHandler('./routes/comicat/keyword'));

// Mikan Anime
router.get('/mikan/user/:token', lazyloadRouteHandler('./routes/mikan/user'));

// M-Team
router.get('/mteam/bookmarked', lazyloadRouteHandler('./routes/mteam/bookmarked'));
router.get('/mteam/:keyword?', lazyloadRouteHandler('./routes/mteam/keyword'));

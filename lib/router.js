...
router.get('/nyaa/user/:user', require('./routes/nyaa/user'));

// 漫猫BT
router.get('/comicat/:keyword?', require('./routes/comicat/keyword'));

// Mikan Anime
router.get('/mikan/user/:token', require('./routes/mikan/user'));

// M-Team
router.get('/mteam/bookmarked', require('./routes/mteam/bookmarked'));
router.get('/mteam/:keyword?', require('./routes/mteam/keyword'));
